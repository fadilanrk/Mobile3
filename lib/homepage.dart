    ...
    return Column(
      ...
      children: [
        ...
        GridView.count(
          ...
          children: [
            _buildProductItem('Sepatu Stylish', 'https://example.com/shoes.jpg', 59.99),
            _buildProductItem('Tas Elegan', 'https://example.com/bag.jpg', 79.99),
            _buildProductItem('Sneakers Trendy', 'https://example.com/sneakers.jpg', 49.99),
            _buildProductItem('Backpack Fashion', 'https://example.com/backpack.jpg', 69.99),
          ],
        ),
      ],
    );
